#Initialise
var engine1 = engines.Turboprop.new(0, 0, 0.2);
var engine2 = engines.Turboprop.new(1, 0, 0.2);
var engine3 = engines.Turboprop.new(2, 0, 0.2);
var engine4 = engines.Turboprop.new(3, 0, 0.2);
var engine5 = engines.Turboprop.new(4, 0, 0.2);
var engine6 = engines.Turboprop.new(5, 0, 0.2);
var engine7 = engines.Turboprop.new(6, 0, 0.2);
var engine8 = engines.Turboprop.new(7, 0, 0.2);
var engine9 = engines.Turboprop.new(8, 0, 0.2);
var engine10 = engines.Turboprop.new(9, 0, 0.2);
...
var engstart = func {
  ...
  settimer(eng4start, 2);
  settimer(eng5start, 2);
  settimer(eng6start, 2);
  settimer(eng7start, 2);
  settimer(eng8start, 2);
  settimer(eng9start, 2);
  settimer(eng10start, 2);
}
